...
public class Registration_RegisterInHotelmania extends SimpleBehaviour{
	...
	public Registration_RegisterInHotelmania(Agent agent) {
		super(agent);
	}
	...
	public void action(){
		...
		try{
			...
			if (res.length > 0){
				...
				// If no new HOTELMANIA has been found, it waits 1 second
				Thread.sleep(1000);
			}	
		}catch (Exception e){
			e.printStackTrace();
